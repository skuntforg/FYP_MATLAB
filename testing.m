...
maxtime = 30 ;             % Upper simulation timer limit, s
...
%     y = dV(1,1) - dv(1,1);
 ...
 %% Calculate the conservative forces
    ...
    [xt(1,1), yt(1,1), vx(1,1), vy(1,1), vr(1,1), Fa, Fr, Fd, Fx, Fy, rho_r(1,1)] = testingapf(xt(1,1), yt(1,1), vx(1,1), vy(1,1), Xg, Yg, xo, yo, noo, Ka, Kr, Kdamp, m, rho_0, dt, xt(1,2), yt(1,2));
    
     [xt(1,2), yt(1,2), vx(1,2), vy(1,2), vr(1,2), Fa2, Fr2, Fd2, Fx2, Fy2, rho_r(1,2), Far, phi_1] = testingapffollower(xt(1,2), yt(1,2), vx(1,2), vy(1,2), Xg, Yg, xo, yo, noo, Ka, Kr, Kdamp, m, rho_0, dt, xt(1,1), yt(1,1), xt(1,3), yt(1,3), dxi, dyi);
     
     fprintf(" in main phi_1 =");
     disp(phi_1);
%     
     [xt(1,3), yt(1,3), vx(1,3), vy(1,3), vr(1,3), Fa3, Fr3, Fd3, Fx3, Fy3, rho_r(1,3), Far, zorg] = testingapffollower2(xt(1,3), yt(1,3), vx(1,3), vy(1,3), Xg, Yg, xo, yo, noo, Ka, Kr, Kdamp, m, rho_0, dt, xt(1,1), yt(1,1), xt(1,2), yt(1,2), dxj, dyj);
     
     fprintf(" in main phi_1 (second rover) =");
     disp(zorg);
% % =========================================================================
% Run the rover model
